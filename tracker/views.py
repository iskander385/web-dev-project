...
# These satisfy the "at least 2 FBV using DRF decorators" requirement
...
# These satisfy the "at least 2 CBV using APIView" requirement
...
class UserProfileView(APIView):
    ...
    def get(self, request):
        ...
        # Add watch stats to the profile response
